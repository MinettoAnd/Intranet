...
//       // initially setter gets called with undefined
//       this.chartCanvas = content;
//       this.getBarChart(this.chartLabels1, this.chartData1, this.chartData2,this.chartData3, this.chartData4,this.scaleLabel1,this.scaleLabel2,this.chartNum, this.title1, this.title2, this.title3, this.title4,this.typeChart);
//     }
//   }
//   constructor() { }
...
// getBarChart(chartLabels1, chartData1, chartData2,chartData3,chartData4,scaleLabel1,scaleLabel2, chartNum, title1, title2, title3, title4,typeChart) {
