...
export class ChartService {
  ...
  // graficos para indicadores

  getChartDataBarLinealx2(chartLabels1, chartData1, chartData2, title, title2, typeChart) {
    const data = {
      labels: chartLabels1,
      datasets: [
        {
  ...
  getChartDataBarLinealx3(chartLabels1, chartData1, chartData2,chartData3, title, title2, title3,typeChart) {
    const data = {
      labels: chartLabels1,
      datasets: [
        {
  ...
  getChartOptionsCantidades(scaleLabel1,scaleLabel2) {
    const options = {
      // callbacks: {
      //   label: function (t, d) {
      //     var xLabel = d.datasets[t.datasetIndex].label;
  ...
  getChartOptionsPocentajes(scaleLabel1,scaleLabel2) {
    const options = {
      // callbacks: {
      //   label: function (t, d) {
      //     var xLabel = d.datasets[t.datasetIndex].label;
