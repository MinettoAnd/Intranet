...
export class DetalleComponent implements OnInit {
  ...
  constructor(public activeModal: NgbActiveModal, private apiService: ClaimsService, private datePipe: DatePipe, private modalService: NgbModal) { }
  ...
  previewPrint() {
    var fecha = this.datePipe.transform(this.listDetalle[0]?.d_registro, 'yyyyMMdd')
    ...
    const modalRef = this.modalService.open(PreviewComponent, { size: 'xl' });
