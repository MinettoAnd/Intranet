...
console.log(60, this.dato);
  ...
  saveComunication() {
      ...
      const data = {
        ...
        tipoPrograma: this.dato.TipoPaciente,
        email: this.dato.CorreoElectronico,
        celular: this.dato.Celular,
        telefono: this.dato.Telefono,
        importe: this.dato.ImpCuotasVencidas,
        miembros: this.dato.TotalMiembros,
        cuotas_morosas: this.dato.periodos_deuda,
