...
@Component({
  selector: 'app-listado-pacientes-emergencia',
  templateUrl: './listado-pacientes-emergencia.component.html',
  styleUrls: ['./listado-pacientes-emergencia.component.scss']
})
export class ListadoPacientesEmergenciaComponent implements OnInit {
  initialSize = 0;
  ...
  optionsWithCaption = {};
  datePipe: any;
  filtro_fecha = moment(new Date()).format('YYYY-MM-DD');
  filtro_sede = '0001';
  filtro_estado = '';
  ...
  constructor(private tableApiservice: EmergenciesService, private exportService: ExportService) {
    ...
    this.filtroForm = new FormGroup({
      filtro_fecha: new FormControl(this.filtro_fecha),
      filtro_sede: new FormControl("0000"),
      filtro_estado: new FormControl("T"),
  });
   }
...
//console.log(this.parameters);
    this.loading();
    this.tableApiservice.getEmergenciesHotelConsultation(this.parameters).subscribe(
  ...
  //console.log(217);
        const form = this.filtroForm.value;
          ...
          this.filtro_sede = form.filtro_sede,
          this.filtro_estado = form.filtro_estado,
