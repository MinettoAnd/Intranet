...
export class ReporteExpedientesComponent implements OnInit {
 ...
 setPage(pageInfo) {
  ...
  onGridReady(params: GridReadyEvent) {
    ...
    console.log(499, this.gridColumnApi);
  }
  ...
  private changePageLimit(limit: any, numberT): void {
    ...
    if(numberT === '1'){
      ...
      this.gridApi.paginationSetPageSize(Number(this.page1.size));
      ...
      this.gridApi.paginationSetPageSize(Number(this.page2.size));
    }if(numberT === '3'){
      if (limit === '0'){
