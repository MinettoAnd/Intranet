...
@Component({
  selector: 'app-dashboard-ipress',
  templateUrl: './dashboard-ipress.component.html',
  styleUrls: ['./dashboard-ipress.component.scss']
})
export class DashboardIpressComponent implements OnInit {
